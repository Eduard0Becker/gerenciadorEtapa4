public class ValidadorEtapa4 {
	...
	public static void main(String[] args){
		...
		Cosmetico lojaCosmetico = new Cosmetico("Loja Cosmético", 10, 2100, e1, d1, (double) 20, 10);
		System.out.println("\n[OK] Classe Cosmetico identificada");
		
		//public void setTaxaComercializacao(double taxaComercializacao)
		lojaCosmetico.setTaxaComercializacao((double) 50);
		...
		//Criação da instância
		Bijuteria lojaBijuteria = new Bijuteria("Loja Bijuteria", 10, 2100, e1, d1, (double) 5000, 10);
		...
		//Criação da instância
		Informatica lojaInformatica = new Informatica("Loja Informática", 10, 2100, e1, d1, (double) 300, 10);
